    ...
    <table>
        ...
        <form method="post" action="?page=makananAddProses">
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="nama_makanan" placeholder="Masukkan nama makanan" required></td>
            </tr>
            <tr>
                <td style="width: 150px;">Daerah Makanan</td>
                <td>:</td>
                <td><input type="text" name="daerah_makanan" placeholder="Masukkan daerah makanan" required></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
